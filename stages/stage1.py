...
class Stage1: # Renamed the class from BoatRideTutorial to Stage1
    ...
    def run(self):
        ...
        while running:
            ...
            if running: # Only draw the game elements if the game loop is still active
                ...
                pygame.display.flip()
                clock.tick(60)
        print("Exiting Stage1.") # Updated message
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption("Stage1 Test") # Updated caption

    tutorial_stage = Stage1(test_screen, "The Boat Man", "The Log Lady") # Instantiating Stage1
    tutorial_stage.run()
    pygame.quit()